section({
  ...
  title: "Section 3: Cybersecurity Fundamentals",
...
<ul>
  <li><b>Confidentiality</b> — only the right people can read your data</li>
  <li><b>Integrity</b> — the data has not been secretly altered</li>
  <li><b>Availability</b> — you can still get at it when you need it</li>
</ul>
...
<ul>
  <li><b>Length</b> — matters far more than complexity. Every extra character multiplies the work.</li>
  <li><b>Unpredictability</b> — not a dictionary word, name, date, or keyboard pattern.</li>
</ul>
...
<ul>
  <li><b>Something you know</b> — a password or PIN</li>
  <li><b>Something you have</b> — a phone, a hardware key</li>
  <li><b>Something you are</b> — fingerprint, face</li>
</ul>
...
<p>Why it works: a stolen password alone is no longer enough to get in.</p>`
  ...
  <tr><td>SMS text code</td><td>Weak but better than nothing</td><td>SIM swapping — an attacker convinces the phone carrier to move your number to their SIM</td></tr>
  ...
  <tr><td>Push approval</td><td>Strong</td><td>"MFA fatigue" — spamming prompts until you tap approve out of annoyance</td></tr>
...
<ul>
  ...
  <li>Downloading pirated software, cracks, and key generators — a classic trojan delivery method</li>
  ...
  <li><b>Drive-by downloads</b> — an unpatched browser exploited just by visiting a page</li>
</ul>
...
<ul>
  <li><b>Signature detection</b> — compares files against a database of known malware fingerprints. Fast and accurate, but blind to brand-new threats. This is why definition updates matter.</li>
  <li><b>Heuristic analysis</b> — flags code that <i>looks</i> like malware structurally.</li>
  <li><b>Behavioural monitoring</b> — watches what a running program does. Rapidly encrypting thousands of files is stopped regardless of whether that program was ever seen before.</li>
  <li><b>Sandboxing</b> — runs a suspicious file in an isolated environment to observe it safely.</li>
</ul>
<p>A <b>false positive</b> is a harmless file wrongly flagged. A <b>false negative</b> — real malware missed — is the more dangerous failure.</p>`
    },
    {
  ...
  <li>Keep <b>real-time protection</b> on — scanning files as they are opened beats occasional manual scans.</li>
...
<p><b>Backups beat everything.</b> Follow the <b>3-2-1 rule</b> — 3 copies, on 2 different media, 1 stored offsite or offline. Ransomware cannot encrypt a backup drive that is unplugged.</p>`
    },
    {
      title: "Safe downloading",
      body: `<ul>
  <li>Download from the <b>official source</b> — the vendor's own site or an official app store. Not the top sponsored ad in a search result, which is a common malware channel.</li>
...
<ul>
  <li><b>Spear phishing</b> — personalised to you specifically, using real details</li>
  <li><b>Whaling</b> — aimed at executives</li>
  <li><b>Smishing</b> / <b>vishing</b> — the same attack by SMS or voice call</li>
  <li><b>Business email compromise</b> — an urgent request for a wire transfer, apparently from your boss</li>
</ul>`
    },
    {
...
<ul>
  <li><b>Manufactured urgency or fear</b> — "Your account will be closed in 24 hours." Panic is the entire mechanism; it stops you checking.</li>
  <li><b>A mismatched link.</b> Hover over it (long-press on mobile) and read the real destination before clicking.</li>
  <li><b>A lookalike sender domain</b> — <code>support@paypa1.com</code>, or a display name that does not match the actual address.</li>
...
<ol>
  <li><b>Disconnect from the network</b> — pull the Wi-Fi or cable. This stops data leaving and ransomware spreading to shared drives.</li>
  <li><b>Change the password</b> for the affected account, <b>from a different, clean device</b>.</li>
  <li><b>Revoke active sessions</b> and check for 2FA devices, forwarding rules, or recovery emails you did not add — attackers add these to keep access after a password change.</li>
  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        "One site's breach lets attackers automatically try that email and password on hundreds of other sites — credential stuffing",
    ...
    },
    {
      ...
      choices: [
        ...
        "Only that the connection is encrypted — criminals can obtain certificates too",
