section({
  ...
  slides: [
    {
      title: "What attackers actually want",
      body: `<p>Almost all everyday attacks are after one of three things:</p>
<ul>
  <li><b>Your accounts</b> — email, banking, social media. Usually stolen by tricking you into typing your password somewhere fake.</li>
  <li><b>Your money</b> — directly, through scams and fake invoices, or by ransoming your files.</li>
...
<p>Signs of infection: sudden slowness, new toolbars or homepages, unknown programs at startup, disabled antivirus, fans running hard while idle, contacts receiving messages you never sent.</p>`
    },
    {
      ...
      body: `<p>Antivirus software mainly works two ways: it compares files against a database of <b>known malware fingerprints</b> (why its updates matter — it cannot recognise what is not yet in the database), and it <b>watches running programs for malicious behaviour</b>, like something suddenly encrypting thousands of files.</p>
  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        "One breach lets attackers try that login on hundreds of other sites — credential stuffing",
    ...
    {
      q: "Why do antivirus definition updates matter?",
      choices: [
        "They make scans finish faster on large drives",
        "Updates renew the program's annual licence so that it keeps running",
        "The fingerprint database cannot recognise malware not yet in it",
        "Old definitions delete files without asking"
      ],
      answer: 2
    },
    {
    ...
    {
      q: "Why can't ransomware destroy a backup kept on an unplugged drive?",
      choices: [
        "Ransomware only targets files smaller than 1 GB",
        "Backup drives use a format malware cannot read",
        "Malware cannot reach a drive that is not connected",
        "Unplugged drives automatically encrypt themselves first"
      ],
      answer: 2
    },
    {
